...
if not exist bin\php\php.exe (
	...
	(
		echo. | set /p v="Installing PHP 7.4.28..."^
		&& powershell -Command "$progressPreference = 'silentlyContinue'; Invoke-WebRequest -Method Get -Uri 'https://windows.php.net/downloads/releases/php-7.4.28-Win32-vc15-x64.zip' -OutFile '%CD%\temp\php.zip';" >nul 2>&1^
